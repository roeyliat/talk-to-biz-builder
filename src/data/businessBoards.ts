...
const iceCreamBoards: Record<string, AACBoard> = {
  ...
  'take-away': {
    ...
    cells: [
      imageCell('box-small', 'קופסא קטנה', 'Small box', 'people', '📦', '/aac-local/flavors/קטן.png', 'flavors-cup'),
      imageCell('box-large', 'קופסא גדולה', 'Large box', 'people', '📦', '/aac-local/flavors/גדול.png', 'flavors-cup'),
    ],
    gridSize: { cols: 2, rows: 1 },
  },
  'sorbet-type': {
  ...
  'flavors-cup': {
    ...
    cells: [
      ...
      imageCell('more-flavor', 'עוד טעם', 'Another flavor', 'verbs', '', '/aac-local/flavors/עוד טעם.png'),
      imageCell('ready-to-order', 'תוספות', 'Toppings', 'people', '🌈', '/aac-local/תוספות.png', 'toppings'),
    ],
  ...
  'toppings': {
    ...
    cells: [
      ...
      imageCell('nuts', 'אגוז לוז', 'Hazelnut', 'people', '🥜', '/aac-local/nuts.png'),
  ...
  'dessert-spreads': {
    ...
    cells: [
      imageCell('spread-nutella', 'ממרח נוטלה', 'Nutella spread', 'people', '🍫', '/aac-local/flavors/נוצ׳לה.png'),
  ...
  'help': {
    ...
    parentBoardId: 'main',
    cells: [
      imageCell('help-staff', 'סליחה, אתה יכול לעזור לי?', 'Excuse me, can you help me?', 'social', '🙋', '/aac-local/flavors/עזרה.png'),
      imageCell('help-menu', 'איפה התפריט?', 'Where is the menu?', 'social', '📋', '/aac-local/flavors/תפריט.png'),
      imageCell('help-restroom', 'איפה השירותים?', 'Where is the restroom?', 'social', '🚻', '/aac-local/flavors/שירותים.png'),
      imageCell('help-allergy', 'יש לי אלרגיה', 'I have an allergy', 'social', '⚠️', '/aac-local/flavors/יש לי אלרגיה.png', 'allergy-info'),
  ...
  'allergy-info': {
    ...
    cells: [
      ...
      imageCell('allergy-fish', 'דגים', 'Fish', 'social', '🐟', '/aac-local/allergies/דגים.png'),
      imageCell('allergy-soy', 'סויה', 'Soy', 'social', '🌱', '/aac-local/allergies/סויה.png'),
      imageCell('allergy-shellfish', 'רכיכות / פירות ים', 'Shellfish / Seafood', 'social', '🦐'),
      imageCell('allergy-something-else', 'משהו אחר', 'Something else', 'social', '⌨️', '/aac-local/allergies/משהו אחר.png'),
    ],
    gridSize: { cols: 2, rows: 5 },
  },
  'payment-bill': {
    id: 'payment-bill',
    name: 'אני רוצה לשלם',
    nameEn: 'I want to pay',
    parentBoardId: 'main',
    cells: [
      imageCell('payment-want-pay', 'אני רוצה לשלם', 'I want to pay', 'verbs', '💳', '/aac-local/flavors/אני רוצה לשלם.png'),
      imageCell('payment-ask-bill', 'אפשר חשבון?', 'Can I have the bill?', 'people', '🧾', '/aac-local/flavors/payment-ask-bill.png'),
      imageCell('payment-credit', 'תשלום באשראי', 'Credit card payment', 'people', '💳', '/aac-local/flavors/payment-credit.png'),
      imageCell('payment-cash', 'תשלום במזומן', 'Cash payment', 'people', '💵', '/aac-local/flavors/payment-cash.png'),
      imageCell('payment-thanks', 'תודה', 'Thank you', 'social', '🙏', '/aac-local/flavors/תודה.png'),
      imageCell('payment-receipt-please', 'קבלה בבקשה', 'Receipt, please', 'people', '🧾', '/aac-local/flavors/payment-receipt.png'),
    ],
    gridSize: { cols: 2, rows: 3 },
  },
  'coffee-size': {
    ...
    cells: [
      imageCell('coffee-size-small', 'קטן', 'Small', 'descriptors', '🔹', '/aac-local/flavors/קטן.png', 'coffee-type'),
      imageCell('coffee-size-medium', 'בינוני', 'Medium', 'descriptors', '🔶', '/aac-local/flavors/בינוני.png', 'coffee-type'),
      imageCell('coffee-size-large', 'גדול', 'Large', 'descriptors', '⬛', '/aac-local/flavors/גדול.png', 'coffee-type'),
    ],
    gridSize: { cols: 3, rows: 1 },
  },
  'coffee-type': {
...
const cafeBoards: Record<string, AACBoard> = {
  ...
  'help': {
    ...
    cells: [
      ...
      imageCell('help-menu', 'איפה התפריט?', 'Where is the menu?', 'social', '📋', '/aac-local/flavors/תפריט.png'),
      imageCell('help-restroom', 'איפה השירותים?', 'Where is the restroom?', 'social', '🚻', '/aac-local/flavors/שירותים.png'),
      imageCell('help-allergy', 'יש לי אלרגיה', 'I have an allergy', 'social', '⚠️', '/aac-local/flavors/יש לי אלרגיה.png'),
    ],
    gridSize: { cols: 2, rows: 2 },
  },
  'taste-menu': {
