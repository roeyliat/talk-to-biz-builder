...
const iceCreamBoards: Record<string, AACBoard> = {
  ...
  'allergy-info': {
    ...
    parentBoardId: 'help',
    cells: [
      cell('allergy-dairy', 'חלב / לקטוז', 'Dairy / Lactose', 'social', '🥛'),
      cell('allergy-gluten', 'גלוטן / חיטה', 'Gluten / Wheat', 'social', '🌾'),
      cell('allergy-nuts', 'אגוזים', 'Nuts', 'social', '🌰'),
      cell('allergy-peanuts', 'בוטנים', 'Peanuts', 'social', '🥜'),
      cell('allergy-eggs', 'ביצים', 'Eggs', 'social', '🥚'),
      cell('allergy-sesame', 'שומשום', 'Sesame', 'social', '🌱'),
