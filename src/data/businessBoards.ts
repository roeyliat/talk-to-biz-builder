...
const iceCreamBoards: Record<string, AACBoard> = {
  ...
  'flavors-cup': {
    ...
    cells: [
      ...
      cell('passionfruit', 'פסיפלורה', 'Passion Fruit', 'people', '🟣', 'toppings'),
      imageCell('lemon', 'לימון', 'Lemon', 'people', '🍋', '/aac-local/lemon.svg', 'toppings'),
      imageCell('mocha', 'מוקה', 'Mocha', 'people', '☕', '/aac-local/coffee.svg', 'toppings'),
      imageCell('coffee', 'קפה', 'Coffee', 'people', '☕', '/aac-local/coffee.svg', 'toppings'),
      imageCell('caramel', 'קרמל', 'Caramel', 'people', '🍯', '/aac-local/caramel.svg', 'toppings'),
      imageCell('dulce-de-leche', 'דולצה למצ׳ה', 'Dulce de Leche', 'people', '🍮', '/aac-local/caramel.svg', 'toppings'),
      imageCell('biscuit', 'ביסקוויט', 'Biscuit', 'people', '🍪', '/aac-local/cookie.svg', 'toppings'),
      imageCell('tiramisu', 'טירמיסו', 'Tiramisu', 'people', '🍰', '/aac-local/קפה בייליס.png', 'toppings'),
      imageCell('hazelnut', 'אגוז לוז', 'Hazelnut', 'people', '🌰', '/aac-local/nuts.svg', 'toppings'),
    ],
