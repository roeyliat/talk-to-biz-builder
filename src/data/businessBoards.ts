...
const iceCreamBoards: Record<string, AACBoard> = {
  ...
  'order-menu': {
    ...
    cells: [
      ...
      imageCell('desserts', 'קינוחים', 'Desserts', 'people', '🍰', '/aac-local/flavors/פנקייק.png', 'desserts'),
  ...
  'ice-cream-type': {
    ...
    parentBoardId: 'main',
    cells: [
      imageCell('cup', 'כוס', 'Cup', 'people', '🥣', '/aac-local/flavors/כוס.png', 'flavors-cup'),
      imageCell('cone', 'גביע', 'Cone', 'people', '🍦', '/aac-local/flavors/גביע.png', 'flavors-cone'),
    ],
    gridSize: { cols: 2, rows: 1 },
  },
  'sorbet-type': {
  ...
  'cold-drinks': {
    ...
    cells: [
      ...
      imageCell('water', 'מים', 'Water', 'people', '💧', '/aac-local/flavors/מים.png'),
      imageCell('iced-coffee', 'קפה קר', 'Iced Coffee', 'people', '🧊', '/aac-local/flavors/קפה קר.png'),
      imageCell('milkshake', 'מילקשייק', 'Milkshake', 'people', '🥤', '/aac-local/flavors/מילקשייק.png'),
  ...
  'flavors-cup': {
    ...
    cells: [
      imageCell('mango', 'מנגו', 'Mango', 'people', '🥭', '/aac-local/flavors/מנגו.png', 'toppings'),
      imageCell('strawberry', 'תות', 'Strawberry', 'people', '🍓', '/aac-local/flavors/תות.png', 'toppings'),
      imageCell('chocolate', 'שוקולד', 'Chocolate', 'people', '🍫', '/aac-local/flavors/שוקולד.png', 'toppings'),
      imageCell('nutella', 'נוצ׳לה', 'Nutella', 'people', '🍫', '/aac-local/flavors/נוצ׳לה.png', 'toppings'),
      imageCell('halva', 'חלווה', 'Halva', 'people', '🍯', '/aac-local/flavors/חלווה.png', 'toppings'),
      imageCell('pistachio', 'פיסטוק', 'Pistachio', 'people', '🥜', '/aac-local/flavors/פיסטוק.png', 'toppings'),
      imageCell('belgian-chocolate', 'שוקולד בלגי', 'Belgian Chocolate', 'people', '🍫', '/aac-local/flavors/שווקולד בלגי.png', 'toppings'),
      imageCell('black-vanilla', 'וניל שחור', 'Black Vanilla', 'people', '🍨', '/aac-local/flavors/וניל שחור.png', 'toppings'),
      imageCell('pine-nut', 'פינולי צנובר', 'Pine Nut', 'people', '🌰', '/aac-local/flavors/פינולי צנובר.png', 'toppings'),
      imageCell('italian-coffee', 'קפה איטלקי', 'Italian Coffee', 'people', '☕', '/aac-local/flavors/קפה איטלקי.png', 'toppings'),
      imageCell('dark-chocolate', 'שוקולד מריר', 'Dark Chocolate', 'people', '🍫', '/aac-local/flavors/שוקולד מריר.png', 'toppings'),
      imageCell('lime-basil', 'ליים בזיליקום', 'Lime Basil', 'people', '🍋', '/aac-local/flavors/ליים בזיליקום.png', 'toppings'),
      imageCell('amsterdam-cookies', 'אמסטרדם קוקיז', 'Amsterdam Cookies', 'people', '🍪', '/aac-local/flavors/אמסטרדם קוקיז.png', 'toppings'),
      imageCell('peanut-butter-raspberry', 'חמאת בוטנים ופטל', 'Peanut Butter & Raspberry', 'people', '🫐', '/aac-local/flavors/חמאת בוטנים ופטל.png', 'toppings'),
      imageCell('salted-caramel-affogato', 'קרמל מלוח עם שברי אפרופו', 'Salted Caramel with Affogato', 'people', '🍯', '/aac-local/flavors/קרמל מלוח עם שברי אפרופו.png', 'toppings'),
      imageCell('mascarpone-berries-crumble', 'מסקרפונה פירות יער וקרמבל', 'Mascarpone Berry Crumble', 'people', '🍰', '/aac-local/flavors/מסקרפונה פירות יער וקרמבל.png', 'toppings'),
    ],
